...
const Signup=()=>{
    ...
    return(
        ...
        <h1 style={{fontFamily:"georgia", fontSize:"50px"}}>Join Our Community</h1>

            <h1 style={{ fontFamily: "georgia", fontSize: "34px", fontWeight: "bold", paddingBottom: "10px" }}>{loading?"Processing":"SignUp"}</h1>
