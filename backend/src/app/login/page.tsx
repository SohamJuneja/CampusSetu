...
const Login=()=>{
    ...
    return(
        ...
        <h1 style={{fontFamily:"georgia", fontSize:"50px"}}>Welcome To Campus Setu</h1>
            <h1 style={{ fontFamily: "georgia", fontSize: "34px", fontWeight:"bold", paddingBottom: "10px" }}>Login</h1>
